...
<body>
    ...
    <div id="footer"><div id="footer2">
		...
		<?php
			$loc_from = $_POST['LocationFrom'];
			$loc_to = $_POST['LocationTo'];
			$price = $_POST['Price'];
			...
			$sql = "INSERT INTO route (LocationFrom, LocationTo, Price)VALUES ('$loc_from', '$loc_to', '$price')";


			$sql = "SELECT DriverIDNO FROM driver";


			$sql = "INSERT INTO post (RouteNo, DriverIDNO)VALUES ('$loc_from', '$loc_to', '$price')";
