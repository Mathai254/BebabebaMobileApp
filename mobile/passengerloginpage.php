  ...
  <body>
    ...
    <div class="form">
       <div id="login">   
          ...
          <form action="passengerloginpage.php" method="post">
            ...
            <p class="message">Not registered? <a href="passengerregister.php">Create an account</a></p>
...
<?php
  ...
  if(isset($_POST['login']))
  {
    ...
    $result = mysqli_query($conn,"SELECT * FROM passenger WHERE email='$email' AND Password='$pass'");
